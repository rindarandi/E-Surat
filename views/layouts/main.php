        ...
        'items' => [
            ...
            ['label' => 'Surat', 
                'items' => [
                    ...
                    ['label' => 'Kategori', 'url' => ['/kategori-surat']],
            ...
            ['label' => 'Disposisi',
                'items' => [
                    ['label' => 'Disposisi Rules Node', 'url' => ['/approval-rules-node']],
                    ['label' => 'Disposisi Rules Edge', 'url' => ['/approval-rules-edge']],
                    ['label' => 'Disposisi Surat Masuk', 'url' => ['/approval-surat-masuk']],
                ],
            ],
            ['label' => 'User',
                'items' => [
                    ['label' => 'User', 'url' => ['/user']],
                    ['label' => 'Jabatan User', 'url' => ['/jabatan-user']],
                ],
            ],
